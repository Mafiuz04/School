...
public class TeacherService {
    ...
    public Teacher changeTeacherPhoneNumber(Long id, ChangePhoneNumber newNumber) {
        return teacherRepository.changeNumber(getTeacher(id), newNumber);
    }

    public List<Teacher> getTeachers(String sex) {
        return Optional.ofNullable(sex).isPresent() ? teacherRepository.getBySex(sex) : teacherRepository.getTeachers();
    }
}
